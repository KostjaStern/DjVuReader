...
public class Iw44FirstChunk extends Iw44Chunk {
    ...
    */
    private byte majorVersionAndColorType;

    private boolean isOneColorComponent;
     ...
     */
    private byte delayCounter;

    private int chrominanceDelayCounter;

    private byte[] data;


    public Iw44FirstChunk() {
